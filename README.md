...
2. 在 [releases](https://github.com/yang12387/doge-reader/releases) 页面下载最新版本的安装包
...
```bash
git clone https://github.com/yang12387/doge-reader.git
```

2. 安装nodejs、cmake、make等必要工具
