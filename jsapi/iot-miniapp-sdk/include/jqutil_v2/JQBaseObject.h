...
private:
    ...
    enum {
        ...
        FLAG_INTERNAL_VALUE_HOLDER = 1 << 2,
        FLAG_INTERNAL_REF_HOLDER = 1 << 3,
        FLAG_ASYNC_EXECUTOR = 1 << 4,
    ...
    inline void _setInternalValueHolderFlag(bool f)
    { f ? _flags |= FLAG_INTERNAL_HOLDER : _flags &= ~FLAG_INTERNAL_VALUE_HOLDER; }
    inline void _setInternalRefHolderFlag(bool f)
    { f ? _flags |= FLAG_INTERNAL_HOLDER : _flags &= ~FLAG_INTERNAL_REF_HOLDER; }
    inline void _setAsyncExecutorFlag(bool f)
    { f ? _flags |= FLAG_ASYNC_EXECUTOR : _flags &= ~FLAG_ASYNC_EXECUTOR; }
    ...
    inline bool _internalValueHolderFlag() const { return _flags & FLAG_INTERNAL_VALUE_HOLDER; }
    inline bool _internalRefHolderFlag() const { return _flags & FLAG_INTERNAL_REF_HOLDER; }
    inline bool _asyncExecutorFlag() const { return _flags & FLAG_ASYNC_EXECUTOR; }
...
public:
    JQInternalValueHolder* getInternalValueHolder() const;
    JQInternalValueHolder* getOrCreateInternalValueHolder();

    JQInternalRefHolder* getInternalRefHolder() const;
    JQInternalRefHolder* getOrCreateInternalRefHolder();
