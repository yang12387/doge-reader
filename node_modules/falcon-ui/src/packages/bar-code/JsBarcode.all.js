...
/******/ 	module.exports = __webpack_require__(__webpack_require__.s = 0);
/******/ })
/************************************************************************/
/******/ ([
/* 0 */
...
var _ErrorHandler = __webpack_require__(47);

var _ErrorHandler2 = _interopRequireDefault(_ErrorHandler);

var _exceptions = __webpack_require__(46);
...
exports.default = { CanvasRenderer: _canvas2.default };
		...
		value: function prepareCanvas() {
			...
			if (maxWidth != this.canvasWidth || maxHeight != this.canvasHeight) {
				if (this.options.scaleType == 'center') {
					var tx = (this.canvasWidth - maxWidth) / 2;
					var ty = (this.canvasHeight - maxHeight) / 2;
					ctx.translate(tx, ty);
				} else if (this.options.scaleType == 'fit') {
					var sx = this.canvasWidth / maxWidth;
					var sy = this.canvasHeight / maxHeight;
					ctx.scale(sx, sy);
				}
			}
